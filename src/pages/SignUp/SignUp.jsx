...
function SignUpSection() {
    ...
    return (
        <section className="ctw-signup-section">
            {/* LEFT — form */}
            <div className="ctw-signup-left">
                <div className="ctw-signup-form-wrap">
                    <h2 className="ctw-signup-title">Sign Up</h2>
                    <p className="ctw-signup-subtitle">welcome please login to your account</p>
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="ctw-field">
                            <label className="ctw-label" htmlFor="ctw-username">Username</label>
                            <input
                                id="ctw-username"
                                name="username"
                                type="text"
                        ...
                        <div className="ctw-field">
                            <label className="ctw-label" htmlFor="ctw-email">Email Address</label>
                            <input
                                id="ctw-email"
                                name="email"
                                type="email"
                        ...
                        <div className="ctw-field ctw-field-password">
                            <label className="ctw-label" htmlFor="ctw-password">Password</label>
                        ...
                        <p className="ctw-password-hint">Must be at least 8 Characters.</p>

                        <button type="submit" className="ctw-btn ctw-submit-btn">
                            Sign Up
                        </button>

                        <p className="ctw-alt-text">
                            Already have an Account?{" "}
                            <Link to="/registration" className="ctw-alt-link">
                                Log in
                            </Link>
                        </p>
                    </form>
            ...
            {/* RIGHT — banner slider */}
            <div
                className="ctw-signup-right"
            // style={{ backgroundImage: `url(${SLIDES[slide].img})` }}
            >
                <div className="ctw-signup-right-overlay" />
                <div className="ctw-signup-right-content">
                    <h2 className="ctw-banner-quote">{SLIDES[slide].quote}</h2>

                    <div className="ctw-banner-meta-row">
                        <div>
                            <h4 className="ctw-banner-name">{SLIDES[slide].name}</h4>
